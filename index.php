...
<head>
    <meta charset="utf-8" />
    <title>Dion | Home</title>
    <meta name="author" content="dion" />
    <meta name="keywords" content="dion cv, cvdion, curriculum vitae dion, cv, dion, daftar riwayat hidup dion" />
    <meta name="description" content="Dion CV - resume with html, css" />
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-lg-5 text-right">
                        ...
                        <div class="foto">
                            <!-- for man -->
                            <img src="./assets/img/photo.png" alt="dion">
                            <!-- for women -->
                    ...
                    <div class="col-xs-12 col-sm-7 col-lg-7">
                        <!-- Your Name -->
                        <h1 class="title">Dian Ananda</h1>
                        <!-- Your Profession -->
                        <h3 class="sub-title">Web Developer & Designer</h3>
                        <!-- social icon -->
                        <div class="social">
                            <ul class="animated" data-animation="fadeIn" data-animation-delay="600">
                                <!-- social icons -->
                                <li><a class="ukie-icons hover-animate" href="https://web.facebook.com/dion.ananda"><i class="fa fa-facebook"></i></a></li>
                                <li><a class="ukie-icons hover-animate" href="https://twitter.com/Dionannd"><i class="fa fa-twitter"></i></a></li>
                                <li><a class="ukie-icons hover-animate" href="https://www.instagram.com/dion.an/?hl=id"><i class="fa fa-instagram"></i></a></li>
                                <li><a class="ukie-icons hover-animate" href="https://www.linkedin.com/in/dian-ananda-552a79152/"><i class="fa fa-linkedin"></i></a></li>
                                <li><a class="ukie-icons hover-animate" href="#"><i class="fa fa-google-plus"></i></a></li>
                                <li><a class="ukie-icons hover-animate" href="https://github.com/dionannd"><i class="fa fa-github"></i></a></li>
                                <!--
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                        ...
                        <a href="profile.php" class="menu-li">
                            <!-- img menu block -->
                            <span class="foto">
                                <!-- for man -->
                                <img src="./assets/img/menu/profile.png" class="menu-img" data-img-name="profile" alt="dion" />
                                <!-- for women -->
                        ...
                        <a href="resume.php" class="menu-li">
                            <!-- img menu block -->
                            <span class="foto">
                                <img src="./assets/img/menu/resume.png" class="menu-img" data-img-name="resume" alt="dion">
                            </span>
                            <!-- name menu block -->
                        ...
                        <a href="portfolio.php" class="menu-li">
                            <!-- img menu block -->
                            <span class="foto">
                                <img src="./assets/img/menu/portfolio.png" class="menu-img" data-img-name="portfolio" alt="dion">
                            </span>
                            <!-- name menu block -->
                        ...
                        <a href="contact.php" class="menu-li">
                            <!-- img menu block -->
                            <span class="foto">
                                <img src="./assets/img/menu/contact.png" class="menu-img" data-img-name="contact" alt="dion">
                            </span>
                            <!-- name menu block -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <a href="javascript:void(0);" class="hover-animate">
                            <span class="ukie-icons hover-animate"><i class="fa fa-phone"></i></span> +62 896-2777-3145
                        </a>
                    </div>
                    <!-- end phone number -->
                    <!-- start email -->
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <a href="javascript:void(0);" class="hover-animate">
                            <span class="ukie-icons hover-animate"><i class="fa fa-paper-plane"></i></span> dionananda77@gmail.com
                        </a>
                    </div>
                    <!-- end email -->
                    <!-- start address -->
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <a href="javascript:void(0);" class="hover-animate">
                            <span class="ukie-icons hover-animate"><i class="fa fa-map-marker"></i></span> Jl. Bojongsari, jatisari, Bekasi
                        </a>
                    </div>
                    <!-- end address -->
                    <!-- start Copyright -->
