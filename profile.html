        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-7 padding-bottom">
                    <h3 class="title">Hello~, My name is Dian Ananda</h3>
                    <p>Call me Dion, I like everything about Design, Computer & Network. My Color favorite is Blue, and me always looking for new knowledge.</p>
                    ...
                    <div class="block-grey">
                        <table>
                            <tr>
                                ...
                                <td class="text-right">Dian Ananda</td>
                            </tr>
                            <tr>
                                <td class="font-weight-m">Date of birth</td>
                                <td class="text-right">February 24, 2000</td>
                            </tr>
                            <tr>
                                <td class="font-weight-m">E-mail</td>
                                <td class="text-right"><a href="mailto:dionananda77@gmail.com">dionananda77@gmail.com</a></td>
                            </tr>
                            <tr>
                                <td class="font-weight-m">Address</td>
                                <td class="text-right">Jl. Bojongsari,Jatisari, Bekasi 17426</td>
                            </tr>
                            <tr>
                                <td class="font-weight-m">Phone</td>
                                <td class="text-right"><a href="tel:01234567890">+62896-2777-3145</a></td>
                            </tr>
                            <tr>
                                <td class="font-weight-m">Website</td>
                                <td class="text-right"><a href="javascript:void(0);">www.dionannd.github.io</a></td>
                            </tr>
                            <tr>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <div class="circle-block ">
                        ...
                        <span class="name hover-animate">Web Dev</span>
                    </div>
                    <div class="circle-block">
                        <span class="icon hover-animate"><i class="fa fa-desktop"></i></span>
                        <span class="name hover-animate">Editor</span>
                    </div>
                    <div class="circle-block">
                        <span class="icon hover-animate"><i class="fa fa-photo"></i></span>
                        <span class="name hover-animate">Design</span>
                    </div>
                </div>
            </div>
            <!-- end row -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-4 col-lg-2"  >
                    <img class="instagram-foto" src="assets/img/img-195x195.jpg" alt="Instagram Feed">
                </div>
                <div class="col-xs-6 col-sm-4 col-lg-2">
                    <img class="instagram-foto" src="assets/img/img-195x195.jpg" alt="Instagram Feed">
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <p class="thoughts">Never giveup with circumstances, must always be excited. </p>
                    <h4 class="sub-title">Dian Ananda</h4>
                </div>
            </div>
            <!-- end row -->
        </div>
