                        ...
                        <div id="education-slider" class="owl-carousel owl-theme">
                            <div class="item">
                                <table>
                                    <tr>
                                        ...
                                        <td>SMK Negeri 04 Bekasi</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Address</td>
                                        <td>Jl. Karanggan Wetan</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="item">
                                <table>
                                    <tr>
                                        <td class="font-weight-m width-td">Name</td>
                                        <td>MI Attaqwa XXVIII</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Address</td>
                                        <td>Jl. Wibawa Mukti 2</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Period</td>
                                        <td>2005-2011</td>
                            ...
                            <div class="item">
                                <table>
                                    <tr>
                                        ...
                                        <td>PT. Yamaha Motor Part Mfg Indonesia</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Address</td>
                                        <td>Kawasan KIIC, Karawang</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Period</td>
                                        <td>2019-now</td>
                                ...
                                <p> - Packing </p>
                                <p> - Operator Debburing </p>
                            </div>
                            <div class="item">
                                <table>
                                    <tr>
                                        <td class="font-weight-m width-td1">Company Name</td>
                                        <td>PT. Suryaraya Rubberindo Industries</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Address</td>
                                        <td>Kawasan Cileungsi, Bogor</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Period</td>
                                        <td>2018-2019</td>
                                ...
                                <p>- Supply Operator</p>
                                <p>- Operator Strapping</p>
                                <p>- Operator Wrapping</p>
                            </div>
                            <div class="item">
                                <table>
                                    <tr>
                                        <td class="font-weight-m width-td1">Company Name</td>
                                        <td>PT. Wiennexindo Solution</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Address</td>
                                        <td>Perum. Bumi Mutiara,Karanggan, Bekasi</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-m">Period</td>
                                        <td>2017</td>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-6 padding-bottom">
                    ...
                    <label class="progress-bar-label">After Effect</label>
                    <div class="progress">
                ...
                <div class="col-xs-12 col-sm-12 col-lg-6">
                    ...
                    <div class="circle-progress-block">
                        ...
                        <label class="circle-progress-label">Fast Learning</label>
                    </div>
                    ...
                    <div class="circle-progress-block">
                        ...
                        <label class="circle-progress-label">Tim Work</label>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-6 language-skills">
                    ...
                    <div class="progress">
                        <label class="progress-bar-label">Indonesia</label>
                        <span class="ratyli" data-rate="5" data-ratemax="5"></span>
                    </div>
                    <div class="progress">
                        <label class="progress-bar-label">English</label>
                        <span class="ratyli" data-rate="2" data-ratemax="5"></span>
                    </div>
                    <div class="progress">
                        <label class="progress-bar-label">Japanese</label>
                        <span class="ratyli" data-rate="1" data-ratemax="5"></span>
                    </div>
                    <div class="progress">
                        <label class="progress-bar-label">French</label>
                        <span class="ratyli" data-rate="0" data-ratemax="5"></span>
                    </div>
                    <div class="progress">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <div class="circle-block ">
                        ...
                        <span class="name hover-animate">Badminton</span>
                    </div>
                    <div class="circle-block">
                    ...
                    <div class="circle-block">
                        ...
                        <span class="name hover-animate">Editing</span>
                    </div>
                </div>
            </div>
            <!-- end row -->
